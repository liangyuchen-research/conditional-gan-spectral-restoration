...
def run():
    ...
    bars1 = ax.bar(x - bar_width, vals_Zn, bar_width,
                   color="skyblue", label="Zn")


    bars2 = ax.bar(x, vals_Ni, bar_width,
                   facecolor="orange", hatch="xx", edgecolor="gray", label="Ni")


    bars3 = ax.bar(x + bar_width, vals_Cu, bar_width,
                   facecolor="plum", hatch="///", edgecolor="gray", label="Cu")
